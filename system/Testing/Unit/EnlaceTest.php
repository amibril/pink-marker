...
class EnlaceTest extends PHPUnit_Framework_TestCase
{
    ...
    {        
        $identificadorEnlaceAgregado = $this->enlacePrueba->agregarEnlace("Nombre enlace","Direccion","Descripcion");
        $this->assertEquals(1,$identificadorEnlaceAgregado);
    }
